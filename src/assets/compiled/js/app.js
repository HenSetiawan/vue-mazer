...
*/ ;(function () {
        ...
        './node_modules/core-js/internals/iterators-core.js': function (s, f, r) {
          ...
          ;[].keys &&
            ((v = [].keys()),
            'next' in v ? ((_ = l(l(v))), _ !== Object.prototype && (A = _)) : (m = !0)),
            A == null && (A = {}),
            !h && !u(A, g) && a(A, g, E),
    ...
    ;(function (s, f) {
      ...
      function os(n, e) {
        ...
        var N = P.reduce(function (B, R) {
          return (
            (B[R] = ct(n, { placement: R, boundary: o, rootBoundary: c, padding: d })[xe(R)]), B
          )
        }, {})
      ...
      function cs(n, e, t) {
        var i = xe(n),
          ...
          y = c[1]
        return (
          (d = d || 0), (y = (y || 0) * o), [ne, oe].indexOf(i) >= 0 ? { x: y, y: d } : { x: d, y }
        )
      }
      function ds(n) {
        var e = n.state,
      ...
      function hs(n) {
        var e = n.state,
          ...
          q = e.rects.popper,
          J =
            typeof R == 'function' ? R(Object.assign({}, e.rects, { placement: e.placement })) : R,
          Z =
            typeof J == 'number'
      ...
      class we extends he {
        ...
        show(e) {
          if (this._isShown || x.trigger(this._element, Na, { relatedTarget: e }).defaultPrevented)
            return
          ;(this._isShown = !0),
            this._backdrop.show(),
      ...
      class ke extends he {
        ...
        show() {
          ...
          const e = x.trigger(this._element, this.constructor.eventName(il)),
            i = (O(this._element) || this._element.ownerDocument.documentElement).contains(
              this._element
            )
        ...
        hide() {
          if (
            !this._isShown() ||
            x.trigger(this._element, this.constructor.eventName(tl)).defaultPrevented
          )
            return
          if (
            (this._getTipElement().classList.remove(Gt), 'ontouchstart' in document.documentElement)
          )
      ...
      class Tt extends he {
        ...
        _initializeTargetsAndObservables() {
          ...
          for (const t of e) {
            ...
            _(i) &&
              (this._targetLinks.set(decodeURI(t.hash), t), this._observableSections.set(t.hash, i))
          }
        }
        _process(e) {
